<?php
    ...
    WHERE c.id_artista = $id_user AND u.flag = 1 AND c.aceitacoes = 3 ORDER BY c.data_contrato DESC";
    ...
    WHERE c.id_artista = $id_user AND u.flag = 1 AND c.aceitacoes = 3 ORDER BY c.data_contrato DESC limit $inicio, $quantidade_pg ";
          ...
          <div class="card-stacked">
            ...
            <div class="card-content" style="margin-top:-30px;">
              ...
              <?php
               ...
               <p class="right"><?php echo date('d/m/y',strtotime($result['data_contrato'])). ' ás '.date('h:i a', strtotime($result['data_contrato'])); ?></p>

               <!--<form action="proc-posts.php" method="post">
                   <input type="hidden" name="id_contrato" value="<?php //echo $result['id_contrato']; ?>">
                   <input type="hidden" name="pagina" value="<?php //echo $pagina; ?>">
                   <input type="hidden" name="escolha" value="falha-comunicacao-para-sucesso">
                    <div class="">
                        <button class="btn">Sucesso</button>
                    </div>
               </form> -->
            </div>
          </div>
