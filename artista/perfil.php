...
/*INICIO de recolher od dados do artista para exibição no perfil e no menu*/
        $iduser = $_SESSION['id_user'];
          $sql = "SELECT u.id_usuario,u.nome,u.sexo,u.email,u.email2,u.cel,u.cel2,u.data_nasc,u.foto,u.background,u.status_com,u.descricao,u.senha,e.id_estado,e.nome as 'estado',e.uf,c.nome as 'categoria' FROM usuario u INNER JOIN tb_estados e
          ON u.id_estado = e.id_estado INNER JOIN categoria c ON u.id_catart = c.id_categoria WHERE u.id_usuario = $iduser";
        $query = mysqli_query($conexao,$sql);
        $dados = mysqli_fetch_assoc($query);
/*FIM  de recolher os DADOS do Banco*/
/*INICIO de Exibição do PERFIL com todos os Dados pegos do BANCO*/
?>
      ...
      <div id = "texto" class="col s12 m4 l4" data-anime="right">
       ...
       <?php
        ...
        <p>
          ...
          <?php echo $dados['estado']."-".$dados['uf']; ?>
        </p>
        <p>
...
<?php
 ...
 ?>
    ...
    <div id = "qsou"class="row ">
      ...
      <p class="centro blue-text text-darken-4 col s12 offset-m2 m8 justificado"data-anime >
        ...
        <div class="row">
          ...
          <div class="col s12 m12 l12">
            <div class="slider">
                <ul class="slides">
                    <?php
                    $sqlfoto="SELECT u.nome, p.id_post, p.titulo, p.data_art, p.descricao, p.foto FROM usuario u INNER JOIN post p ON u.id_usuario = p.id_userpost WHERE p.id_userpost =$iduser AND p.foto IS NOT NULL ORDER BY id_post DESC LIMIT 10";
                  ...
                  <li>
                    <div class="row white">
                      ...
                      <?php }
                        ...
                        <a href = "galeria.php"><p class="text-footer">Galeria</p></a>
                      </div>
                    </div>
                  </li>
<?php }; ?>
...
<!--Carrossel de videos-->
      ...
      <div class="container">
            <div class="row">
              <h2 class="center">Galeria de videos</h2>
              <div class="col s12 m12 l12">
                <div class="slider">
                    <ul class="slides">
<?php
                        $sqlvideo = "SELECT u.nome, p.id_post, p.titulo, p.data_art, p.descricao, p.video FROM usuario u INNER JOIN post p ON u.id_usuario = p.id_userpost WHERE p.id_userpost =$iduser AND p.video IS NOT NULL ORDER BY id_post DESC LIMIT 10";
                          ...
                          <li>
                            <div class="row white">
                              ...
                              <?php }
                                ...
                                <a href = "videos.php"><p class="text-footer">Galeria de Videos</p></a>
                              </div>
                            </div>
                          </li>
    <?php               }; ?>
...
<!-- INICIO DE PAGINAÇÃO-->
    <?php
        ...
        $result_curso = "SELECT c.id_com,c.comentario,c.data_coment,u.nome,u.foto,e.nome as 'estado',e.uf FROM comentario c INNER JOIN usuario u ON c.id_usucom = u.id_usuario INNER JOIN tb_estados e ON u.id_estado = e.id_estado WHERE c.id_artista = $iduser ORDER BY c.data_coment DESC";
        ...
        $result_cursos = "SELECT c.id_com,c.comentario,c.data_coment,u.nome,u.foto,e.nome as 'estado',e.uf FROM comentario c INNER JOIN usuario u ON c.id_usucom = u.id_usuario INNER JOIN tb_estados e ON u.id_estado = e.id_estado WHERE c.id_artista = $iduser
            ...
            <div class="container">
              <div class="card blue lighten-4">
                  <div class="container-noventa">
                    <h5>Postar comentario como <?php echo $dados['nome'];?></h5>
                    <form action="proc-posts.php" method="post" class="row">
                          <div class="col s3 m2 l1">
                            <img src="../img_usuarios/<?php echo $dados['foto'];?>" alt="Foto de comentario" class="responsive-img coment-img"/>
                          </div>
                          ...
                          <div class="input-field col s9 m10 l11">
                            ...
                            <label for="textarea">Escreva o seu comentario aqui</label>
                              <input type="hidden" name="escolha" value="postar-comentario">
                      ...
                      <div class="card blue lighten-4">
                        <div class="card-content ">
                          ...
                          <button class="btn delete blue">
                            <a class="modal-trigger" onClick="excluir(<?php echo $comentarios['id_com']; ?>,<?php echo $pagina; ?>);" href="#excluir-com" style="color:white;">Deletar</a>
                          </button>


                          <script type="text/javascript">
                          //valores para excluir
                              function excluir(id,id_pagina){
                    ...
                    <ul class="pagination">
                        <li class="waves-effect">
                            ...
                            if($pagina_anterior != 0){ ?>
                                <a href="perfil.php?pagina=<?php echo $pagina_anterior; ?>">
                       ...
                       <?php
                         ...
                         if ($pagina_anterior > 0) {
                           ...
                           echo '<li><a href="perfil.php?pagina='.$pagina_anterior.'">'.$pagina_anterior.'</a></li>';

                         }

                         echo '<li class="active  blue accent-3"><a href="perfil.php?pagina='.($pagina).'">'.($pagina).'</a></li>';

                         if ($pagina + 1 <= $num_pagina) {

                           echo '<li><a href="perfil.php?pagina='.($pagina+1) .'">'.($pagina+1).'</a></li>';
                        ...
                        <li class="waves-effect">
                            ...
                            if($pagina_posterior <= $num_pagina){ ?>
                                <a href="perfil.php?pagina=<?php echo $pagina_posterior; ?>" >
    ...
    <div class="modal-content">
      ...
      <p class="centro">
        <form action="proc-posts.php" method="post">
          ...
          <input type='hidden' name='escolha' value='excluir-comentario'/>
