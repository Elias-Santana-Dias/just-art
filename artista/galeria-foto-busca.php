...
<html>
 ...
 <body id ="galeria">
   <?php
    ...
    //$sqlfoto = "SELECT u.id_usuario,u.nome, p.id_post, p.titulo, p.data_art, p.descricao, p.foto FROM usuario u INNER JOIN post p ON u.id_usuario = p.id_userpost WHERE p.id_userpost =$id_artista AND p.foto IS NOT NULL ORDER BY id_post DESC";
    //$queryfoto = mysqli_query($conexao,$sqlfoto);
    //$posts = mysqli_num_rows($queryfoto);
