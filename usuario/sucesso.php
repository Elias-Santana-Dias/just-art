<?php
    ...
    WHERE c.id_user = $id_user AND u.id_usuario = c.id_artista AND c.aceitacoes = 2 ORDER BY c.data_contrato DESC";
    ...
    WHERE c.id_user = $id_user AND u.id_usuario = c.id_artista AND c.aceitacoes = 2 ORDER BY c.data_contrato DESC limit $inicio, $quantidade_pg ";
