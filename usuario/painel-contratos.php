<?php
    ...
    $result_curso = "SELECT c.id_contrato,c.descricao,c.data_contrato,c.id_user as 'id_contratante',u.id_usuario,u.nome,u.sexo,u.email,u.email2,u.cel,u.cel2,u.foto,e.nome as 'estado',e.uf FROM contratar c INNER JOIN  usuario u INNER JOIN tb_estados e ON e.id_estado = u.id_estado
    WHERE c.id_user = $id_user AND u.id_usuario = c.id_artista AND c.aceitacoes = 1 ORDER BY c.data_contrato DESC";
    ...
    $result_cursos = "SELECT c.id_contrato,c.descricao,c.data_contrato,c.id_user as 'id_contratante',u.id_usuario,u.nome,u.sexo,u.email,u.email2,u.cel,u.cel2,u.foto,e.nome as 'estado',e.uf FROM contratar c INNER JOIN  usuario u INNER JOIN tb_estados e ON e.id_estado = u.id_estado
    WHERE c.id_user = $id_user AND u.id_usuario = c.id_artista AND c.aceitacoes = 1 ORDER BY c.data_contrato DESC limit $inicio, $quantidade_pg ";
      ...
      <body>
        <?php
          ...
          if($total_cursos < 0 || $total_cursos == null ){ ?>
              <h3 style="text-align:center">No momento você não tem nenhum contrato Enviado.</h3>
...
<?php  exit(); }; ?>
    ...
    <h3 class="blue-text center">Painel de Contratos Enviados</h3>
<div class="container">
  <div class="row">
   <ul>
...
<?php   while($result = mysqli_fetch_assoc($query)){?>
      ...
      <div class="col s12 m12" data-anime="left">
        <div class="card horizontal">
          <div class="card-image">
            <a href="busca-art-perfil.php?id_artista=<?php echo $result['id_usuario'];?>"><img src="../img_usuarios/<?php echo $result['foto'];?>" title="<?php echo $result['nome']; ?>" alt="contratante <?php echo $result['nome']; ?>" class="img-cardd" style="object-fit:contain;object-position:top;"></a>
          </div>
          <div class="card-stacked">
            ...
            <div class="card-content" style="margin-top:-30px;">
              ...
              <?php
               ...
               <div class="row">
                   <div class="col s2">
                       <button class="btn"><a class="modal-trigger" href="#cancelar<?php echo $result['id_contrato']; ?>" style="color:white;">Cancelar</a></button>
                     </div>
               </div>
               <!--<div class="row">
                   <form action="proc-edit-perfil.php" method="post">
                       ...
                       <input type="hidden" name="escolha" value="cancelar-contrato">
                        <div class="col s2">
    ...
    <div id="cancelar<?php echo $result['id_contrato']; ?>" class="modal mod-deletar">
      <div class="modal-content">
        <h5 class="blue-text centro">Você tem certeza ?</h5>
        <p>Você está prestes a excluir esse contrato enviado para "<?php echo $result['nome']; ?>", após clicar em "sim" não havera como recuperar o contrato enviado.</p>
        <p class="centro">
          <form action="proc-edit-perfil.php" method="post">
